...
class Enhance_event:
    ...
    def Start(self):
        ...
        while (self.total_coal > 0) and (weapon.level < 5):
...
total_coal, total_buff = 25000, 99999
iter_num = 10000

w1 = Weapon_ss()
w1.total_charge = 546273
w1.update_level()
...
for i in range(iter_num):
    ...
    result_buff.append(e.flag_buff)
...
print(np.mean(np.array(result_buff)))
