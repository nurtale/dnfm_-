...
class Weapon_ss:
    def __init__(self):
        ...
        self.charge_thres = [151405, 246802, 408102, 728366, 1228004, 1940642, 3361784, 5408471, 7613461, 9997614, 12643711]
        self.enhance_cost = [170, 181, 205, 234, 255, 288, 307, 331, 359, 398]
...
class Enhance_event:
    ...
    def Start(self):
        ...
        while (self.total_coal > 0) and (weapon.total_charge < 3361784):
...
total_coal, total_buff = 20000, 30
iter_num = 100000

w1 = Weapon_ss()
w1.total_charge = 151405
w1.update_level()
